            ...
            if (activeTransform != null && activeTransform.GetComponent<MeshRenderer>() && (Tools.current == Tool.Move || Tools.current == Tool.Rotate) && (activeTransform.GetComponent<SnapRecognize>() == null))
            {
                ...
                if (SnapInfo.handles2Pointer && !Selection.activeTransform.tag.Equals("EditorOnly") && (Tools.current == Tool.Move))
                {
                    ...
                    if (feasibleTarget)
                    {
                        ...
                        if (SnapInfo.isFreeMoveHandle)
                        {
                            ...
                            {
                                var fmh_466_102_639047701769206736 = Quaternion.identity; currentHandlePos = Handles.FreeMoveHandle(controlId, handlePosition, size, snap, Handles.CircleHandleCap);
                            }
                        }
                        ...
                        if (currentHandlePos != handlePosition && !SnapInfo.isVertexClickSnapping)
                        {
                            ...
                            if (SnapInfo.isFreeMoveHandle)
                            {
                                var fmh_488_83_639047701769215996 = Quaternion.identity; Handles.FreeMoveHandle(controlId, handlePosition, size, snap, Handles.CircleHandleCap);
                            }
                ...
                else
                {
                    ...
                    if (SnapInfo.isFreeMoveHandle && !Selection.activeTransform.tag.Equals("EditorOnly") && (Tools.current == Tool.Move))
                    {
                        ...
                        if (!SnapInfo.isVertexClickSnapping)
                        {
                            var fmh_519_88_639047701769222616 = Quaternion.identity; currentHandlePos = Handles.FreeMoveHandle(handleCenterPos, size, snap, Handles.CircleHandleCap);
                        }
                        ...
                        if (GUI.changed && !SnapInfo.isVertexClickSnapping)
                        {
                            ...
                            var fmh_527_79_639047701769223196 = Quaternion.identity; Handles.FreeMoveHandle(controlId, handlePosition, size, snap, Handles.CircleHandleCap);
